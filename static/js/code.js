...
Code.init = function() {
  ...
  // Add to reserved word list: Local variables in execution environment (runPY)
  // and the infinite loop detection function.
  Blockly.Python.addReservedWords('code,timeouts,checkTimeout');
...
document.write('<script src="js/msg/code_demos/' + Code.LANG + '.js"></script>\n');
// Load Blockly's language strings.
document.write('<script src="js/msg/blockly/' + Code.LANG + '.js"></script>\n');
